...
/**
 * Binds to todoist.* keys in application.yml.
 * Activate with @EnableConfigurationProperties(TodoistProperties.class)
 * or @ConfigurationPropertiesScan on your main class.
 */
...
public record TodoistProperties(
    ...
    public static final String API_BASE_URL = "https://api.todoist.com/rest/v2";
}