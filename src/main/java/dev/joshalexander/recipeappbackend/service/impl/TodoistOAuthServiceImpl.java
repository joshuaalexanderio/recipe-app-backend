...
public class TodoistOAuthServiceImpl implements TodoistOAuthService {
     ...
     * For production, move this to Redis or a DB table with TTL.
     * Key = state string, Value = userId that initiated the flow.
     */
    ...
    /**
     * POSTs to Todoist's token endpoint to exchange the authorization code.
     * Todoist expects form-encoded params: client_id, client_secret, code.
