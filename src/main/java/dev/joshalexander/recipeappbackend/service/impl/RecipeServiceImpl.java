...
public class RecipeServiceImpl implements RecipeService {
  ...
  public RecipeServiceImpl(EntityMapper recipeMapper, RecipeRepository recipeRepository,
      IngredientRepository ingredientRepository, UserServiceImpl userService) {
  ...
  public RecipeDTO createRecipe(RecipeCreateDTO recipeCreateDTO) {
    ...
    for (RecipeIngredientCreateDTO recipeIngredientCreateDTO : recipeCreateDTO.getRecipeIngredients()) {
      ...
      RecipeIngredient recipeIngredient = getRecipeIngredient(recipeIngredientCreateDTO, ingredient,
          recipe);
  ...
  private static @NotNull RecipeIngredient getRecipeIngredient(
      RecipeIngredientCreateDTO recipeIngredientDTO, Ingredient ingredient, Recipe recipe) {
  ...
  private String findOrCreateIngredientByName(RecipeIngredientCreateDTO recipeIngredientCreateDTO) {
    Optional<String> existingIngredientName = ingredientRepository.findDistinctNameIgnoreCase(
        recipeIngredientCreateDTO.getName().trim());
  ...
  private void updateRecipeIngredients(Recipe recipe,
      List<RecipeIngredientUpdateDTO> recipeIngredientUpdates) {
